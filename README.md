...
### Local
Abrí `index.html` directamente en cualquier navegador moderno. No requiere servidor.

### GitHub Pages
El proyecto es 100% estático y se puede desplegar gratis:

1. **Settings → Pages → Source: Deploy from a branch**
2. Branch: `main`, Folder: `/ (root)` → Save.
3. Disponible en `https://<usuario>.github.io/<repo>/` tras ~1 minuto.
...
```
app-verona/
├── index.html   # UI: header, paneles laterales, canvas, modal de recorte
├── style.css    # Tema oscuro, botones por color, layout grid
├── script.js    # Toda la lógica: herramientas, eventos Fabric, helpers
└── README.md
```
